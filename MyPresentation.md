...
*[Shiny App]* - [https://mousan.shinyapps.io/NewApplication/]

*[Github Repo]* - [https://github.com/mouhsinea/Final-Project-Submission]
...
<span style="color:blue; font-weight:bold;font-size:0.7em">A Shiny application was developed based on the next word prediction model described previously as shown below. </span><img src="Capture.png"></img>
